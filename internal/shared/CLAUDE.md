...
### `aws`
SQS producer/consumer toolkit (added 2026-07, user-designed — not scaffolded from a template). **Not yet wired into any app** — `apps/relay`'s `OutboxService.ProcessBatch` doesn't call any of this yet; it's a standalone library today.
